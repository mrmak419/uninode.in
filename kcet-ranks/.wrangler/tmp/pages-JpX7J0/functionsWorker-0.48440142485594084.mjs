...
`, { html: true });
      ...
      const cat2 = url.searchParams.get("cat");
      const seat = url.searchParams.get("seat");
      if (cat2) canonicalUrl.searchParams.set("cat", cat2);
...
// ../.wrangler/tmp/pages-JpX7J0/functionsRoutes-0.5907130568542734.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-8THKxB/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-8THKxB/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.48440142485594084.mjs.map
